...
class GraphLine : androidx.appcompat.widget.AppCompatImageView {
    ...
    var clickX = 0.0
    var clickY = 0.0
    var colorGraphLine = resources.getColor(R.color.color1, null)
    var colorLine = resources.getColor(R.color.gray, null)
    var backgroundGraphColor = resources.getColor(R.color.white, null)
